...
export const ABOUT_TEAM_BIOS = [
  {
    ...
    bio: [
      ...
      "Started building businesses at 15. Ran a four-figure e-commerce business, built and sold a company where he co-ordinated sell-out events, and actively invests in crypto, index funds, and stocks.",
      "Personal interests include: gym, painting, travelling, and currently trying to learn the guitar.",
    ],
  ...
  },
  {
    ...
    role: "Co-Founder",
    bio: [
      "Brings ambition and positivity to the team. Always pushing the vision forward and finding ways to improve and innovate.",
      "Director and Marketing Lead for his previous company, then Head of Marketing for a biotech startup. Over 2 million views across TikTok and Instagram pages.",
      "Personal interests include: gym, football, travelling, and experiencing new cultures and perspectives.",
    ],
  ...
  },
  {
    ...
    role: "Co-Founder",
    bio: [
      "The project manager and connector of the team. Keeps the team aligned and ensures that our projects remain efficient and within scope.",
      "Built a social media audience of over 125,000 followers, ran e-commerce sales across 18+ countries, and led a sold-out sporting event with 600+ tickets sold.",
      "Charlie has travelled to 40 countries, which has helped develop strong people skills and the ability to connect with different cultures.",
    ],
  ...
  },
  {
    ...
    bio: [
      ...
      "Ran a property investment business for 4 years and was Chief Operations Officer for his previous, now sold, company.",
      "Liam enjoys reading fiction and keeping active in the gym.",
    ],
